...
<img src="docs/overview.jpg" width="100%" alt="Plannify.exe Enterprise Academic Operations Interface" style="border-radius: 12px; box-shadow: 0 20px 50px rgba(0,0,0,0.18);" />
