...
export default function LandingPage({ onExploreDemo }) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 selection:bg-indigo-500 selection:text-white font-sans antialiased overflow-x-hidden">
      ...
      <header className="sticky top-0 z-50 bg-white/95 dark:bg-slate-900/90 backdrop-blur-md border-b border-slate-200 dark:border-slate-800/80 transition-all">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-xs font-semibold text-slate-600 dark:text-slate-300">
            ...
            <a href="#metrics" className="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">Live Impact</a>
            <a href="#comparison" className="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">Why Plannify</a>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="max-w-4xl mx-auto text-center space-y-6">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
              <button
                onClick={handleLaunchApp}
                className="w-full sm:w-auto btn-primary text-sm py-3.5 px-8 font-black shadow-xl shadow-indigo-500/25 flex items-center justify-center gap-2.5 hover:scale-105 active:scale-95 transition-all"
              >
            ...
            {/* Micro Trust Proofs */}
            <div className="pt-6 flex flex-wrap items-center justify-center gap-x-8 gap-y-3 text-xs font-semibold text-slate-500 dark:text-slate-400">
              ...
              <span className="flex items-center gap-2">
                <svg className="w-4 h-4 text-indigo-600 dark:text-indigo-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><polyline points="20 6 9 17 4 12"/></svg>
          ...
          >
            ...
            <div className="flex items-center justify-between pb-3 px-2 border-b border-slate-200 dark:border-slate-800 text-xs">
              <div className="flex items-center gap-2">
                ...
                <span className="ml-2 font-mono text-[11px] text-slate-500 dark:text-slate-400">plannify://academic-operations/command-center</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="w-2 h-2 rounded-full bg-emerald-500 pulse-live-dot" />
                <span className="text-[11px] font-bold text-emerald-600 dark:text-emerald-400">Constraint Engine: 100% Conflict-Free</span>
              </div>
            </div>
            ...
            <div className="p-4 sm:p-6 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 p-5 rounded-2xl bg-slate-50 dark:bg-slate-950/80 border border-slate-200 dark:border-slate-800">
                <div className="space-y-1">
                  <span className="text-[10px] font-bold uppercase tracking-wider text-indigo-600 dark:text-indigo-400">Live Optimization</span>
                  <h3 className="text-xl font-black text-slate-900 dark:text-white">Full University Schedule</h3>
                  <p className="text-xs text-slate-500 dark:text-slate-400">LNCT Group of Institutions · Fall Semester 2026</p>
                ...
                <div className="flex items-center justify-around md:col-span-2 gap-4">
                  ...
                  />
                  <div className="w-px h-14 bg-slate-200 dark:bg-slate-800" />
                  <RadialProgressDial
                    value={94}
                    size={86}
                    strokeWidth={7}
                  ...
                  />
                  <div className="w-px h-14 bg-slate-200 dark:bg-slate-800 hidden sm:block" />
                  <div className="hidden sm:block text-right">
                    <p className="text-[10px] uppercase font-bold text-slate-500 dark:text-slate-400">Solve Time</p>
                    <p className="text-2xl font-black text-slate-900 dark:text-white">
                      <AnimatedCounter target={3.2} decimals={1} suffix="s" />
                    </p>
                    <p className="text-[10px] text-emerald-600 dark:text-emerald-400 font-bold">OR-Tools Engine</p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between text-xs font-bold text-slate-500 dark:text-slate-400 px-1">
                  ...
                  <span className="text-emerald-600 dark:text-emerald-400 font-bold">0 Overlaps Detected</span>
                </div>

                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 text-xs">
                  <div className="p-3 rounded-xl bg-white dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700/60 shadow-sm stat-card-elevate">
                    <span className="text-[10px] font-bold text-indigo-600 dark:text-indigo-400 block">MCA-A · Slot 1 (9:00 - 9:45 AM)</span>
                    <p className="font-bold text-slate-900 dark:text-white mt-1">Data Structures & Algo</p>
                    <p className="text-[11px] text-slate-500 dark:text-slate-400">Prof Ripusoodan S. · Room 101</p>
                  </div>

                  <div className="p-3 rounded-xl bg-white dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700/60 shadow-sm stat-card-elevate">
                    <span className="text-[10px] font-bold text-purple-600 dark:text-purple-400 block">MCA-A · Slot 2 (9:45 - 10:30 AM)</span>
                    <p className="font-bold text-slate-900 dark:text-white mt-1">Database Management</p>
                    <p className="text-[11px] text-slate-500 dark:text-slate-400">Dr Satish Manwani · Lab 2</p>
                  </div>

                  <div className="p-3 rounded-xl bg-white dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700/60 shadow-sm stat-card-elevate">
                    <span className="text-[10px] font-bold text-emerald-600 dark:text-emerald-400 block">MCA-B · Slot 1 (9:00 - 9:45 AM)</span>
                    <p className="font-bold text-slate-900 dark:text-white mt-1">Operating Systems</p>
                    <p className="text-[11px] text-slate-500 dark:text-slate-400">Prof Vivek Sharma · Room 102</p>
                  </div>

                  <div className="p-3 rounded-xl bg-white dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700/60 shadow-sm stat-card-elevate">
                    <span className="text-[10px] font-bold text-teal-600 dark:text-teal-400 block">MCA-B · Slot 2 (9:45 - 10:30 AM)</span>
                    <p className="font-bold text-slate-900 dark:text-white mt-1">Software Engineering</p>
                    <p className="text-[11px] text-slate-500 dark:text-slate-400">Prof Amit Shrivastava · Room 103</p>
                  </div>
                </div>
              </div>
      ...
      <section id="metrics" className="py-20 bg-slate-100/70 dark:bg-slate-900/50 border-b border-slate-200 dark:border-slate-800/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <SpotlightCard className="card p-6 bg-white dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 shadow-sm stat-card-elevate text-center">
              ...
              <h3 className="text-4xl font-black text-emerald-600 dark:text-emerald-400 font-display">
            ...
            <SpotlightCard className="card p-6 bg-white dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 shadow-sm stat-card-elevate text-center">
              ...
              <h3 className="text-4xl font-black text-indigo-600 dark:text-indigo-400 font-display">
            ...
            <SpotlightCard className="card p-6 bg-white dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 shadow-sm stat-card-elevate text-center">
              ...
              <h3 className="text-4xl font-black text-purple-600 dark:text-purple-400 font-display">
      ...
      <section id="features" className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 bg-white dark:bg-slate-950">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <SpotlightCard className="card p-8 bg-slate-50/80 dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 shadow-md stat-card-elevate relative overflow-hidden flex flex-col justify-between">
            <div className="space-y-4">
              ...
              <h3 className="text-2xl font-black text-slate-900 dark:text-white font-display">AI Timetable Constraint Engine</h3>
              ...
              <ul className="space-y-2 text-xs text-slate-600 dark:text-slate-400 pt-2">
                <li className="flex items-center gap-2">
                  <span className="text-emerald-600 dark:text-emerald-400 font-bold">✓</span> 100% Conflict-Free Parallel Sections
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-emerald-600 dark:text-emerald-400 font-bold">✓</span> Continuous Multi-Slot Lab Allocations
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-emerald-600 dark:text-emerald-400 font-bold">✓</span> Clustered Free Period Optimization
                </li>
              </ul>
            </div>
            <div className="pt-6 border-t border-slate-200 dark:border-slate-800/80 mt-6 flex items-center justify-between text-xs">
          ...
          <SpotlightCard className="card p-8 bg-slate-50/80 dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 shadow-md stat-card-elevate relative overflow-hidden flex flex-col justify-between">
            <div className="space-y-4">
              ...
              <h3 className="text-2xl font-black text-slate-900 dark:text-white font-display">Real-Time Leave & Substitute Match</h3>
              <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
              ...
              <ul className="space-y-2 text-xs text-slate-600 dark:text-slate-400 pt-2">
                <li className="flex items-center gap-2">
                  <span className="text-emerald-600 dark:text-emerald-400 font-bold">✓</span> Real-Time Leave Approval & Rejection Drawer
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-emerald-600 dark:text-emerald-400 font-bold">✓</span> Automatic Proxy Teacher Qualification Matching
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-emerald-600 dark:text-emerald-400 font-bold">✓</span> Dynamic Balance Tracking (Casual, Sick, Academic)
                </li>
              </ul>
            </div>
            <div className="pt-6 border-t border-slate-200 dark:border-slate-800/80 mt-6 flex items-center justify-between text-xs">
          ...
          <SpotlightCard className="card p-8 bg-slate-50/80 dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 shadow-md stat-card-elevate relative overflow-hidden flex flex-col justify-between">
            <div className="space-y-4">
              ...
              <h3 className="text-2xl font-black text-slate-900 dark:text-white font-display">Institutional Attendance & Analytics</h3>
              <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
              ...
              <ul className="space-y-2 text-xs text-slate-600 dark:text-slate-400 pt-2">
                <li className="flex items-center gap-2">
                  <span className="text-emerald-600 dark:text-emerald-400 font-bold">✓</span> Live Department Attendance Percentage Gauges
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-emerald-600 dark:text-emerald-400 font-bold">✓</span> Faculty Fatigue & Overload Early Warning Alerts
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-emerald-600 dark:text-emerald-400 font-bold">✓</span> NAAC & NBA Audit-Ready Record Generation
                </li>
              </ul>
            </div>
            <div className="pt-6 border-t border-slate-200 dark:border-slate-800/80 mt-6 flex items-center justify-between text-xs">
          ...
          <SpotlightCard className="card p-8 bg-slate-50/80 dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 shadow-md stat-card-elevate relative overflow-hidden flex flex-col justify-between">
            <div className="space-y-4">
              ...
              <h3 className="text-2xl font-black text-slate-900 dark:text-white font-display">Multi-Role Portal Perspectives</h3>
              <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed">
              ...
              <ul className="space-y-2 text-xs text-slate-600 dark:text-slate-400 pt-2">
                <li className="flex items-center gap-2">
                  <span className="text-emerald-600 dark:text-emerald-400 font-bold">✓</span> Dedicated Teacher Portal with Verified Profile Switcher
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-emerald-600 dark:text-emerald-400 font-bold">✓</span> Classroom & Lab Master Occupancy Views
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-emerald-600 dark:text-emerald-400 font-bold">✓</span> One-Click Departmental PDF & Excel Schedule Printing
                </li>
              </ul>
            </div>
            <div className="pt-6 border-t border-slate-200 dark:border-slate-800/80 mt-6 flex items-center justify-between text-xs">
      ...
      <section id="solutions" className="py-24 bg-slate-100/70 dark:bg-slate-900/50 border-y border-slate-200 dark:border-slate-800/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            {/* Role Switcher Tabs */}
            <div className="flex flex-wrap items-center justify-center gap-2 mt-8 p-1.5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl max-w-2xl mx-auto shadow-sm">
          ...
          <SpotlightCard className="max-w-5xl mx-auto card p-8 bg-white dark:bg-slate-900/95 border border-slate-200 dark:border-slate-800 shadow-xl stat-card-elevate">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              ...
              <div className="lg:col-span-7 space-y-4">
                <span className="inline-block px-3 py-1 rounded-full text-xs font-bold bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 border border-indigo-500/30">
                  {currentRole.tag}
                </span>
              ...
              <div className="lg:col-span-5 space-y-4 p-6 rounded-2xl bg-slate-50 dark:bg-black/40 border border-slate-200 dark:border-slate-800">
                <div className="flex items-center justify-between pb-3 border-b border-slate-200 dark:border-slate-800">
                  <span className="text-xs font-bold text-slate-900 dark:text-white">{currentRole.previewTitle}</span>
                ...
                <div className="grid grid-cols-3 gap-3 text-center py-2">
                  <div className="p-2.5 rounded-xl bg-white dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 shadow-sm">
                    <p className="text-[10px] text-slate-500 dark:text-slate-400">{currentRole.kpi1.label}</p>
                    <p className="text-sm font-black text-slate-900 dark:text-white mt-1">{currentRole.kpi1.val}{currentRole.kpi1.suffix}</p>
                  </div>
                  <div className="p-2.5 rounded-xl bg-white dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 shadow-sm">
                    <p className="text-[10px] text-slate-500 dark:text-slate-400">{currentRole.kpi2.label}</p>
                    <p className="text-sm font-black text-indigo-600 dark:text-indigo-400 mt-1">{currentRole.kpi2.val}{currentRole.kpi2.suffix}</p>
                  </div>
                  <div className="p-2.5 rounded-xl bg-white dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 shadow-sm">
                    <p className="text-[10px] text-slate-500 dark:text-slate-400">{currentRole.kpi3.label}</p>
                    <p className="text-sm font-black text-emerald-600 dark:text-emerald-400 mt-1">{currentRole.kpi3.val}{currentRole.kpi3.suffix}</p>
                  </div>
                </div>
      ...
      <section id="comparison" className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 bg-white dark:bg-slate-950">
        ...
        <div className="card overflow-hidden bg-white dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 max-w-5xl mx-auto shadow-xl">
          <div className="overflow-x-auto">
            <table className="w-full text-xs text-left border-collapse">
              <thead>
                <tr className="bg-slate-50 dark:bg-slate-950 border-b border-slate-200 dark:border-slate-800 text-slate-700 dark:text-slate-300">
                  <th className="py-4 px-6 font-bold uppercase tracking-wider text-[11px]">Feature Capability</th>
                  <th className="py-4 px-6 font-black text-indigo-600 dark:text-indigo-400 uppercase tracking-wider text-[11px] bg-indigo-50 dark:bg-indigo-500/10 border-x border-indigo-200 dark:border-indigo-500/20">
                    Plannify Academic OS
                  </th>
                  <th className="py-4 px-6 font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider text-[11px]">Legacy ERP (OpenEduCat/SAP)</th>
                  <th className="py-4 px-6 font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider text-[11px]">Manual Excel / Sheets</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-slate-200 dark:divide-slate-800/80">
                ...
                <tr>
                  <td className="py-4 px-6 font-bold text-slate-900 dark:text-white">Automated Conflict Checking</td>
                  <td className="py-4 px-6 font-black text-emerald-600 dark:text-emerald-400 bg-indigo-50/50 dark:bg-indigo-500/5 border-x border-indigo-200 dark:border-indigo-500/20">✓ 100% Mathematical Constraint Solved</td>
                  <td className="py-4 px-6 text-slate-600 dark:text-slate-300">✓ Basic Constraint Alerts</td>
                  <td className="py-4 px-6 text-rose-500 dark:text-rose-400">✗ High Human Error &amp; Clashes</td>
                </tr>
                <tr>
                ...
                <tr>
                  <td className="py-4 px-6 font-bold text-slate-900 dark:text-white">Cloud Sync &amp; Multi-Device Access</td>
                  <td className="py-4 px-6 font-black text-emerald-600 dark:text-emerald-400 bg-indigo-50/50 dark:bg-indigo-500/5 border-x border-indigo-200 dark:border-indigo-500/20">✓ Supabase Real-Time Live Sync</td>
                  <td className="py-4 px-6 text-slate-600 dark:text-slate-300">✓ Server-Based</td>
                  <td className="py-4 px-6 text-rose-500 dark:text-rose-400">✗ Stale Local Copies</td>
                </tr>
              </tbody>
            </table>
          </div>
      ...
      <section id="faq" className="py-24 bg-slate-100/70 dark:bg-slate-900/50 border-t border-slate-200 dark:border-slate-800/60">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          
          <div className="text-center mb-14">
            <span className="text-xs uppercase font-bold text-indigo-600 dark:text-indigo-400 tracking-wider">Got Questions?</span>
            <h2 className="text-3xl sm:text-4xl font-black text-slate-900 dark:text-white tracking-tight mt-1 font-display">
              ...
              return (
                ...
                >
                  <button
                    ...
                    className="w-full p-5 text-left flex items-center justify-between gap-4 font-bold text-slate-900 dark:text-white text-sm hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors"
                  >
                    <span>{faq.q}</span>
                    <span className={`text-lg text-indigo-600 dark:text-indigo-400 transition-transform ${isOpen ? 'rotate-180' : ''}`}>
                      ↓
                    </span>
                  </button>
                  {isOpen && (
                    <div className="px-5 pb-5 text-xs text-slate-600 dark:text-slate-300 leading-relaxed border-t border-slate-200 dark:border-slate-800/60 pt-3 animate-slide-down">
                      {faq.a}
                    </div>
                  )}
                </div>
      ...
      <section className="py-20 relative overflow-hidden bg-white dark:bg-slate-950">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="rounded-3xl p-8 sm:p-14 bg-gradient-to-r from-indigo-600 via-indigo-700 to-violet-700 text-white text-center shadow-2xl relative overflow-hidden">
            <div className="absolute top-0 right-0 w-96 h-96 bg-white/10 blur-3xl rounded-full pointer-events-none" />

            <div className="max-w-2xl mx-auto space-y-5">
              <span className="inline-block px-3 py-1 rounded-full text-xs font-black bg-white/20 text-white uppercase tracking-wider">
              ...
              <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-4">
                <button
                  onClick={handleLaunchApp}
                  className="w-full sm:w-auto px-8 py-3.5 rounded-2xl bg-white text-indigo-950 hover:bg-slate-100 font-black text-sm shadow-xl flex items-center justify-center gap-2 hover:scale-105 active:scale-95 transition-all"
                >
                  <span>Launch Live Portal</span>
                  <svg className="w-4 h-4 text-indigo-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>
                </button>
      ...
      <footer className="bg-slate-900 dark:bg-slate-950 border-t border-slate-800 text-slate-400 text-xs py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-6 font-semibold">
            ...
            <button onClick={handleLaunchApp} className="text-indigo-400 hover:underline">
              Portal Sign In
            </button>
          </div>
        </div>

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center sm:text-left pt-6 mt-6 border-t border-slate-800 text-[11px] text-slate-500 flex flex-col sm:flex-row items-center justify-between gap-3">
