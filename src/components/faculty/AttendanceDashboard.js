      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        {!isTeacherView && (
          <div className="flex flex-wrap items-center gap-3">
            ...
            <button
              onClick={() => exportAttendanceToPdf(records, viewDate)}
              className="px-3 py-2 rounded-xl bg-rose-500/15 hover:bg-rose-500/25 border border-rose-500/40 text-xs font-bold text-rose-700 dark:text-rose-300 transition-all flex items-center gap-1.5 shadow-sm"
              title="Download Official PDF Attendance Register"
            >
            ...
            <button
              onClick={() => exportAttendanceToExcel(records, viewDate)}
              className="px-3 py-2 rounded-xl bg-emerald-500/15 hover:bg-emerald-500/25 border border-emerald-500/40 text-xs font-bold text-emerald-700 dark:text-emerald-300 transition-all flex items-center gap-1.5 shadow-sm"
              title="Download Excel (.xlsx) Attendance Sheet"
            >
