    ...
    <div className="space-y-6 animate-fade-in text-slate-100">
        ...
        <div className="card p-5 bg-slate-900/90 border border-slate-800 space-y-3">
          <div className="flex items-center justify-between">
            <h3 className="text-xs font-bold uppercase tracking-wider text-slate-400 flex items-center gap-1.5">
              ...
              Daily Progression Timeline (Drag to re-order periods)
            </h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <div className="card p-6 bg-slate-900 border border-slate-800 space-y-4">
            ...
            >
              ...
              Generate Complete Bell Schedule
            </button>
          </div>
        ...
        <div className="lg:col-span-5 space-y-4">
          <div className="card p-6 bg-slate-900 border border-slate-800 space-y-4">
            <h3 className="text-sm font-bold uppercase tracking-wider text-white flex items-center gap-2">
              <svg className="w-4 h-4 text-indigo-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></svg>
              Institutional Bell Templates
            </h3>
            <p className="text-xs text-slate-400">
