...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      { id: "departments", label: "Departments", icon: "building-2", badge: null },
...
export default function SidebarNav({
  ...
  return (
    <aside
      className={`fixed left-0 top-16 bottom-0 z-20 bg-slate-900/95 backdrop-blur-md border-r border-slate-800 transition-all duration-300 flex flex-col ${
        isOpen ? "w-64" : "w-16"
      }`}
    >
